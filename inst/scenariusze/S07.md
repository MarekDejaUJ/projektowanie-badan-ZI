...
Archiwum cyfrowe chce sprawdzić, czy opisy pozwalają odbiorcy rozpoznać przydatne jednostki. Interesuje je związek postrzeganej zrozumiałości z korzystaniem z zasobu, a nie samo zwiększenie liczby wyszukań.
...
Grupy: z doświadczeniem / bez doświadczenia. Z doświadczeniem: wcześniejsza samodzielna praca z opisami archiwalnymi; bez doświadczenia: pierwszy taki kontakt. Doświadczenie dotyczy opisów i struktury archiwum, nie wykształcenia ogółem.

Obserwacyjne badanie przekrojowe; grupy nie są randomizowane.

Indeks: Ocena zrozumiałości opisów archiwalnych. To wynik z sześciu deklarowanych ocen, nie test wszystkich kompetencji ani niezależny audyt usługi.

Pierwsze pytanie: jaka jest różnica średnich indeksu w porównaniu „z doświadczeniem minus bez doświadczenia”? Estymandą jest różnica średnich w populacjach określonych w planie; estymatę obliczamy z dostępnej próby. Jednostka to punkt indeksu. H0 zakłada różnicę równą zero.

Druga relacja: częstość użycia a indeks.
...
Zadanie: Znajdź opis jednostki odpowiadającej wskazanemu tematowi i okresowi oraz podaj jej sygnaturę.
...
Pole `powodzenie` zachowuje wspólną nazwę techniczną. Treść pytania: „Czy udało się znaleźć opis potrzebnej jednostki?”

Źródło wartości: zapis obserwatora według podanego kryterium.

Kod 1: wskazano właściwy opis i sygnaturę.
Kod 0: zakończono próbę bez obu poprawnych wskazań.
NA oznacza nieznany wynik lub brak odpowiedzi, a nie kod 0.

Zrozumiałość oceniona w ankiecie nie jest ekspercką oceną kompletności opisu ani dowodem poprawnego zrozumienia wszystkich terminów.
